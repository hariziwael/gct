  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12 bg-gray-50">
      ...
      <nav className="text-sm text-gray-500 mb-6 flex items-center">
        ...
        <span className="mx-2">&raquo;</span>
        <span className="font-semibold text-blue-700">Stratégie Environnementale</span>
      </nav>
      ...
      <section className="bg-white shadow-lg rounded-xl p-6 md:p-10 mb-12">
        ...
        <div className="p-6 rounded-lg bg-yellow-50 shadow-sm border border-yellow-200">
          <h2 className="text-2xl font-bold text-yellow-700 mb-4 flex items-center">
            <svg className="w-7 h-7 mr-3 text-yellow-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zm-2 2a1 1 0 00-1 1v3a1 1 0 001 1h2a1 1 0 001-1v-3a1 1 0 00-1-1H9z" clipRule="evenodd"></path></svg>
